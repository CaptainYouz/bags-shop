cart.controller('CartController', function ($scope, paymentInfo, Cart, Utils) {
	...
	$scope.easterEag = function () {
		Utils.specialMessagePopUp('Hi Aswat Team !', '<br/>Unfortunately, it ends here... :(<br/><br/>I hope you enjoyed to shop some bags !<br/><br/>And i also hope to see you all soon in Dubaï ;) <br/><br/>Anas.', 'Hire me');
	}
});
